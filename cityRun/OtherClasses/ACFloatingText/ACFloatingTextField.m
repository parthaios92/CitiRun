...
- (CGRect)textRectForBounds:(CGRect)bounds {
    return CGRectMake(45, 4, bounds.size.width-45, bounds.size.height);
}
...
//        _selectedPlaceHolderColor = [UIColor colorWithRed:19/256.0 green:141/256.0 blue:117/256.0 alpha:1.0];
        _selectedPlaceHolderColor = [UIColor grayColor];
    }
...
//        _selectedLineColor = [UIColor colorWithRed:19/256.0 green:141/256.0 blue:117/256.0 alpha:1.0];
        _selectedLineColor = [UIColor grayColor];
    }
...
//*** changed the x value from 2 to 45
//    _labelPlaceholder = [[UILabel alloc]initWithFrame:CGRectMake(45, 0, self.frame.size.width-5, CGRectGetHeight(self.frame))];
    _labelPlaceholder = [[UILabel alloc]initWithFrame:CGRectMake(45, 0, self.frame.size.width-5, CGRectGetHeight(self.frame))];
...
//***Changed x value from 5 to 45 from***
//    CGRect frame = CGRectMake(5, 0, self.frame.size.width-5, self.frame.size.height);
    CGRect frame = CGRectMake(45, 0, self.frame.size.width-45, self.frame.size.height);
    CGRect bottmLineFrame = bottomLineView.frame;
    bottmLineFrame.origin.y = CGRectGetHeight(self.frame)-1;
    [UIView animateWithDuration:0.2 animations:^{
        _labelPlaceholder.frame = frame;
